...
#define BinLocation "c:\GITHUB\ModelBase\bin\Release\net7.0-windows"
...
AppId={{D6CD6A49-0451-4B59-BB63-1A8C0796C31B}
AppName={#MyAppName}
...
OutputBaseFilename=ModelbaseSetup-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=Modellenbeheer [www.sobek.tools]
...
;Source: "{#SetupLocation}\{#ribasimviewer}"; DestDir: "{app}\{#viewerdir}"

[Messages]
BeveledLabel=Modellenbeheer by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\Modelbase.exe"; WorkingDir: "{app}"; Comment: "Start Modellenbeheer"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\Modelbase.exe"; WorkingDir: "{app}"; Comment: "Start Modellenbeheer"
